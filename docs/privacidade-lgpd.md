...
DETRAN PR: Emissão de CRLV-e segue a LGPD (Lei nº 13.709/2018).
...
Acessar, corrigir, eliminar, portar, revogar consentimento. Contato: [detran_pr_crlve@mcp.ai](mailto:detran_pr_crlve@mcp.ai). Reclamações: [ANPD](https://www.gov.br/anpd/pt-br).
